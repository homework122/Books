  ...
  render() {
    ...
    return (
        <div>
          <Row>
            <Col span={24}>
              <div style={{ padding: '10px', borderTop: 'none', overflow: 'hidden', marginBottom: '10px' }}>
                <Input name='username' placeholder="用户名" style={{ width: '250px', float: 'left' }} onChange={this.selectName} />
                <Input name='phone' placeholder="电话" style={{ width: '250px', float: 'left', marginLeft:'20px' }} onChange={this.selectPhone} />
                <Button shape="circle" icon={<SearchOutlined />} size='middle' style={{ float: 'left', marginLeft: '30px' }} onClick={this.SelectBut.bind(this)} />
              </div>
            </Col>
          </Row>
          <Row>
